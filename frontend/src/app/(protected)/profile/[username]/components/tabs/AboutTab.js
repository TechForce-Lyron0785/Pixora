  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Bio section */}
        <div className="bg-gradient-to-br from-zinc-900/80 to-zinc-900/40 backdrop-blur-lg rounded-2xl border border-white/10 p-8 hover:border-violet-500/20 transition-all duration-300 shadow-lg">
